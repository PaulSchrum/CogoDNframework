...
namespace ExampleWithGraphics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const int NumberOfVertices = 6; // 500;
        ...
        void Create(List<Vertex> vertices)
        {
            ...
            txtBlkTimer.Text = string.Format("{0} faces", voronoiMesh.Triangles.Count());
        ...
        private void btnFindDelaunay_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach(var cell in voronoiMesh.Triangles)
            {
